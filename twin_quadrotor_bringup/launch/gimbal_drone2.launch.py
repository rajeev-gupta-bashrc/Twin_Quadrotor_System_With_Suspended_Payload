...
def generate_launch_description():
    ...
    pkg_ardupilot_gazebo = get_package_share_directory("twin_quadrotor_gazebo")
    pkg_ardupilot_description = get_package_share_directory("twin_quadrotor_description")
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_description, "models", "gimbal_drone2", "model.sdf"
    )
